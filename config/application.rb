...
module Htwk2ical
  class Application < Rails::Application
    ...
    config.latest_valid_date = Time.new(2020, 9, 30, 20)

    # date and week when semester started
    config.start_date = Time.new(2020, 10, 5)
    ...
    config.single_subjects_html_url   = 'https://stundenplan.htwk-leipzig.de/ws/Berichte/Text-Listen;Studenten-Sets;name;###SLUG###?template=UNEinzelGru&weeks=35-63'
    config.studium_generales_html_url = 'https://stundenplan.htwk-leipzig.de/ws/Berichte/Text-Listen;Module;id;###SLUG###?template=UNEinzelLV&weeks=35-63'
  end
end
