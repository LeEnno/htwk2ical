...
module Htwk2ical
  class Application < Rails::Application
    ...
    config.latest_valid_date = Time.new(2018, 3, 12, 19)

    # date and week when semester started
    config.start_date = Time.new(2018, 4, 2)
    ...
    config.single_subjects_html_url   = 'http://stundenplan.htwk-leipzig.de:8080/ss/Berichte/Text-Listen;Studenten-Sets;name;###SLUG###?template=UNEinzelGru&weeks=14-64'
    config.studium_generales_html_url = 'http://stundenplan.htwk-leipzig.de:8080/ss/Berichte/Text-Listen;Module;id;###SLUG###?template=UNEinzelLV&weeks=14-64'
  end
end
