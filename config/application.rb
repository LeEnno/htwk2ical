...
module Htwk2ical
  class Application < Rails::Application
    ...
    config.latest_valid_date = Time.new(2015, 9, 28, 19, 0)

    # date and week when semester started
    config.start_date = Time.new(2015, 8, 31)
    ...
    config.single_subjects_html_url   = 'http://stundenplan.htwk-leipzig.de:8080/ws/Berichte/Text-Listen;Studenten-Sets;name;###SLUG###?template=UNEinzelGru&weeks=36-62'
    config.studium_generales_html_url = 'http://stundenplan.htwk-leipzig.de:8080/ws/Berichte/Text-Listen;Module;id;###SLUG###?template=UNEinzelLV&weeks=36-62'
